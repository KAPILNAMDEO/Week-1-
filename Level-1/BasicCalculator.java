/*11.Write a program to create a basic calculator that can perform addition, subtraction, multiplication, and division.
...
Perform Arithmetic Operations of addition, subtraction, multiplication and division and assign the result
 to a variable and finally print the result
I/P => number1, number2
...
public class BasicCalculator {
    public static void main(String[] args) {
		...
		float substraction=number2-number1;
